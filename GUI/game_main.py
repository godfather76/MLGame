...
class MainGameWidget(util.GroupBoxWidget):
    ...
    def __init__(self, root, *args, **kwargs):
        ...
        self.location_name, self.location_desc = self.get_room_info()
    ...
    def go_direction(self, direction):
        self.update_main(f'Going {direction}')

    def send_command(self):
        if self.entry_box.text().strip():
            self.update_main(f'{self.entry_box.text()}')
            self.entry_box.clear()

    def show_skills(self):
        self.update_main('Showing Skills information')

    def show_status(self):
        self.update_main('Showing Status information')

    def show_inventory(self):
        self.update_main('Opening Inventory...')
    ...
    def right_panel(self):
        ...
        self.status_btn = qt.PushButton(self.root,
                                        ...
                                        func=self.show_status)

        self.skills_btn = qt.PushButton(self.root,
                                        text='Skills',
                                        layout=status_skills_layout,
                                        func=self.show_skills)
        ...
        self.nw_btn = qt.PushButton(self.root,
                                    ...
                                    loc=(1,1),
                                    func=lambda: self.go_direction('northwest'))
        ...
        self.n_btn = qt.PushButton(self.root,
                                    ...
                                    layout=button_container,
                                    loc=(1,2),
                                   func=lambda: self.go_direction('north'))
        ...
        self.ne_btn = qt.PushButton(self.root,
                                    ...
                                    layout=button_container,
                                    loc=(1,3),
                                    func=lambda: self.go_direction('northeast'))
        ...
        self.w_btn = qt.PushButton(self.root,
                                   ...
                                   layout=button_container,
                                   loc=(2,1),
                                   func=lambda: self.go_direction('west'))
        ...
        self.up_btn = qt.ToolButton(self.root,
                                    layout=up_dn_layout,
                                    func=lambda: self.go_direction('up'))
        ...
        self.down_btn = qt.ToolButton(self.root,
                                      layout=up_dn_layout,
                                      func=lambda: self.go_direction('down'))
        ...
        self.e_btn = qt.PushButton(self.root,
                                   ...
                                   layout=button_container,
                                   loc=(2,3),
                                   func=lambda: self.go_direction('east'))
        ...
        self.s_btn = qt.PushButton(self.root,
                                   ...
                                   layout=button_container,
                                   loc=(3,2),
                                   func=lambda: self.go_direction('south'))
